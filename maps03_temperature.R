...
loadlibrary(plotrix)
loadlibrary(cmocean)
#par(mar=c(7,4,4,6)) # extra room
#options(repr.plot.width=20,repr.plot.height=10)
pdf("shipmap.pdf",width = 11,height=8.5,family = "Courier")  # also jpeg() png()  pdf() ## IF you want to save map to file
